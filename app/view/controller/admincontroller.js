...
exports.add_rooms = function(req, res) {
    ...
    if(session.admin_id !== undefined){
        if(req.body.hotel_id !== undefined){
            ...
            config.con.query("INSERT INTO `hotel_room`(`hotel_id`, `room_name`, `room_images`, `washroom_images`, `balcony_images`, `overview_images`, `background_image`, `room_type`, `beds`, `room_size`, `room_facilities`, `description`, `price`, `breakfast`, `dinner`) VALUES ('"+req.body.hotel_id +"','"+req.body.room_name +"','"+room_images +"','"+washroom_images +"','"+balcony_images +"','"+overview_images +"','"+background_image +"','"+req.body.room_type +"','"+req.body.beds +"','"+req.body.room_size +"','"+req.body.room_facilities +"','"+req.body.description +"','"+req.body.price +"','"+req.body.breakfast +"','"+req.body.dinner +"')",(err,result) => {
            if(err) console.log(err);
